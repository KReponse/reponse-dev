                ...
                <div className="mt-6 flex items-center gap-3 border-t border-white/10 pt-5">
                  ...
                  {project.live !== "#" ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group/live inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white transition-all hover:bg-blue-500 hover:shadow-lg hover:shadow-blue-600/20"
                    >
